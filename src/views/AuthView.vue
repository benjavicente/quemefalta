...
async function handleGoogleLogin() {
  ...
  try {
    ...
    // Google redirige al usuario; no hay vuelta acá
  } catch (e: any) {
...
<template>
  <div class="auth-wrap">
    <div class="auth-card">
      <div class="mark">★</div>
      <h1 class="title">QueMeFalta</h1>
      <div class="sub">EL ÁLBUM DEL MUNDIAL · TU COLECCIÓN</div>

      <div class="tagline">
        Marca tus láminas. Identifica las que faltan.<br />
